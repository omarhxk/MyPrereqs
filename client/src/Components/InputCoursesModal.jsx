...
function InputCoursesModal() {
    ...
    return(
        <form className="flex flex-col justify-center space-y-9 mx-auto w-3/4 h-180 bg-neutral-50 shadow-xl ring-2 ring-slate-50 rounded-2xl" onSubmit={main}>
